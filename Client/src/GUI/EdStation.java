...
public class EdStation extends JDialog {
	...
	public EdStation(ArrayList<Station> list,Station station)
	{
	...
	{
		cityField.setText(tempstation.getCity());
		acc_desField.setText(tempstation.getAccessDescribe());
		cordXField.setText(tempstation.getCordX()+"");
		cordYField.setText(tempstation.getCordY()+"");
		numerField.setText(tempstation.getStreetNo());
		zip_codeField.setText(tempstation.getZip_Code());
		adrField.setText(tempstation.getStreet());
		nrStaField.setText(tempstation.getStationNum());
		nrNetWorksField.setText(tempstation.getNetWorksNum());
		nrPTCField.setText(tempstation.getPTCNum());
		nrPTKField.setText(tempstation.getPTKNum());
		descField.setText(tempstation.getStationDescribe());
		PTCName.setText(tempstation.getPTCName());
		PTKName.setText(tempstation.getPTKName());
		regionField.setText(tempstation.getRegion());
		ownerField.setText(tempstation.getOwner());
		typeField.setText(tempstation.getType());
		heightField.setText(tempstation.getHeight());
		PlusField.setText(tempstation.getPlusNum());
		PlayField.setText(tempstation.getPlayNum());
		stationHeight.setText(tempstation.getBuilding_height());
		statNameField.setText(tempstation.getStationName());
		power_plantField.setText(tempstation.getPowerPlantNum());
	...
	public class AddListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			log.setText("edytowano");*/
			list.add(tempstation);
			new DataBaseQuery().update(tempstation);
			setVisible(false);
